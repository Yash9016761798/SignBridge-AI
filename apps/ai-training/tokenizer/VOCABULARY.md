...
The SignBridge AI Vocabulary manages word-to-index mappings for sign language translation. It
supports configurable frequency thresholds, maximum size limits, and special tokens.
